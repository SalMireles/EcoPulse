...
def get_postal_codes():
    ...
    column_types = {"zip": str, "city": str, "state": str, "lat": float, "lon": float}

    df = pd.read_csv(f"{CURRENT_DIR}/postal_codes.csv", names=column_names, skiprows=1)
