...
from seeds import (seed_air_conditioner_table, seed_appliance_table,
                   seed_heat_pump_table, seed_heater_table,
                   seed_household_table, seed_household_utilities_table,
                   seed_location_table, seed_manufacturer_table,
                   seed_power_generator_table, seed_water_heater_table)
